...
if(class_exists('WP_Importer'))
{
    ...
    class WP_Import extends WP_Importer
    {
        ...
        function process_menu_item($item)
        {
            ...
            $_menu_item                                = array();
            $_menu_item['_menu_item_type']             = '';
            $_menu_item['_menu_item_object_id']        = '';
            $_menu_item['_menu_item_menu_item_parent'] = '';
            $_menu_item['_menu_item_target']           = '';
            $_menu_item['_menu_item_classes']          = '';
            $_menu_item['_menu_item_xfn']              = '';
            $_menu_item['_menu_item_url']              = '';
            $_menu_item['_menu_item_object']           = '';
            foreach($item['postmeta'] as $meta)
            {
                $_menu_item[$meta['key']] = $meta['value'];
            }
            ...
            {
                if($menu_item->object_id == $_menu_item['_menu_item_object_id'] || ($menu_item->type == 'custom' && $item['post_title'] == $menu_item->post_title && $item['url'] == $menu_item->url ))
                {
                    $item_exists = TRUE;
                }
            }

            if('taxonomy' == $_menu_item['_menu_item_type'] && isset($this->processed_terms[intval($_menu_item['_menu_item_object_id'])]))
            {
                $_menu_item['_menu_item_object_id'] = $this->processed_terms[intval($_menu_item['_menu_item_object_id'])];
            }
            else if('post_type' == $_menu_item['_menu_item_type'] && isset($this->processed_posts[intval($_menu_item['_menu_item_object_id'])]))
            {
                $_menu_item['_menu_item_object_id'] = $this->processed_posts[intval($_menu_item['_menu_item_object_id'])];
            }
            else if('custom' != $_menu_item['_menu_item_type'] && !$item_exists)
            {
            ...
            if(isset($this->processed_menu_items[intval($_menu_item['_menu_item_menu_item_parent'])]))
            {
                $_menu_item['_menu_item_menu_item_parent'] = $this->processed_menu_items[intval($_menu_item['_menu_item_menu_item_parent'])];
            }
            else if($_menu_item['_menu_item_menu_item_parent'])
            {
                $this->menu_item_orphans[intval($item['post_id'])] = (int)$_menu_item['_menu_item_menu_item_parent'];
                $_menu_item['_menu_item_menu_item_parent']         = 0;
            }

            // wp_update_nav_menu_item expects CSS classes as a space separated string
            $_menu_item['_menu_item_classes'] = maybe_unserialize($_menu_item['_menu_item_classes']);
            if(is_array($_menu_item['_menu_item_classes']))
                $_menu_item['_menu_item_classes'] = implode(' ', $_menu_item['_menu_item_classes']);

            $args = array(
                'menu-item-object-id'   => $_menu_item['_menu_item_object_id'],
                'menu-item-object'      => $_menu_item['_menu_item_object'],
                'menu-item-parent-id'   => $_menu_item['_menu_item_menu_item_parent'],
                'menu-item-position'    => intval($item['menu_order']),
                'menu-item-type'        => $_menu_item['_menu_item_type'],
                'menu-item-title'       => $item['post_title'],
                'menu-item-url'         => $_menu_item['_menu_item_url'],
                'menu-item-description' => $item['post_content'],
                'menu-item-attr-title'  => $item['post_excerpt'],
                'menu-item-target'      => $_menu_item['_menu_item_target'],
                'menu-item-classes'     => $_menu_item['_menu_item_classes'],
                'menu-item-xfn'         => $_menu_item['_menu_item_xfn'],
